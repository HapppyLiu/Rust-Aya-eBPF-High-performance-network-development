...
**契约**: [learning-artifact-contract §E](../../contracts/001-rust-foundation/learning-artifact-contract.md)
...
| m7（C-22…C-24） | ✅ **已满足** | 2026-09-11 | `cd experiments/001-rust-foundation/m7-nostd && cargo build` 成功；`tools/check-nostd-artifact.sh` 与 `tools/m7-probe-errors.sh` 退出码 0；host Miri `c24_bump_alloc` 3 项 clean；`criteria/c22…c24.md` 三项 `pass`；`feynman/m7-nostd.md` 五项检验全 `pass` |
