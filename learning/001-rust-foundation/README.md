...
> ⚠️ 本目录属于 **Answer Track**。如果你正在自测，先读 [`../../learner/001-rust-foundation/`](../../learner/001-rust-foundation/README.md)。

| 文件 | 契约 | 内容 |
|-----|------|------|
| `mN-<module>/concept.md` | [§A](../../contracts/001-rust-foundation/learning-artifact-contract.md) | 本模块回答什么问题 / 每个 Capability 的一句话定义、底层机制、常见误解、对应实验 / 与后续 Linux·eBPF·Aya 的关联（FR-014） |
