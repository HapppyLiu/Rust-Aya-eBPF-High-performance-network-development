...
下列路径从仓库根起算，本 Feature 的实验位于 `experiments/001-rust-foundation/`。
验收命令示例：`cd experiments/001-rust-foundation/m7-nostd && cargo build`。
...
| no_std 构建 | `cd experiments/001-rust-foundation/m7-nostd && cargo build` |
