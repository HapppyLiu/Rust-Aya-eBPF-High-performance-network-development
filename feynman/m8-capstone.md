...
完整观察：[`examples/capstone.rs`](../experiments/m8-capstone/examples/capstone.rs)
以及下表链接的 `src/`。每段 ≤15 行。
...
[`buffer.rs`](../experiments/m8-capstone/src/buffer.rs)
...
[`wire.rs`](../experiments/m8-capstone/src/wire.rs)
...
[`parse.rs`](../experiments/m8-capstone/src/parse.rs)
...
[`error.rs`](../experiments/m8-capstone/src/error.rs)
...
[`iter.rs`](../experiments/m8-capstone/src/iter.rs)
...
[`stats.rs`](../experiments/m8-capstone/src/stats.rs)
...
[`raw.rs`](../experiments/m8-capstone/src/raw.rs)
...
[`wire.rs`](../experiments/m8-capstone/src/wire.rs) · 说明：[`capability-location-map.md`](../acceptance/capability-location-map.md)
...
[`lib.rs`](../experiments/m8-capstone/src/lib.rs) · 分配断言：[`tests/capstone.rs`](../experiments/m8-capstone/tests/capstone.rs)
