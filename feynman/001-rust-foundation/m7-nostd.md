...
完整观察：[`src/main.rs`](../../experiments/001-rust-foundation/m7-nostd/src/main.rs)、
[`src/c22_nostd.rs`](../../experiments/001-rust-foundation/m7-nostd/src/c22_nostd.rs)
...
完整观察：[`src/c23_core_alloc_std.rs`](../../experiments/001-rust-foundation/m7-nostd/src/c23_core_alloc_std.rs)
...
完整观察：[`src/c24_panic_alloc.rs`](../../experiments/001-rust-foundation/m7-nostd/src/c24_panic_alloc.rs)、
[`src/bump.rs`](../../experiments/001-rust-foundation/m7-nostd/src/bump.rs)
...
1. 产物不能在本机执行。Independent Test 还过吗？本模块把"可运行"定义成什么？
   → spec US7 Independent Test；`cd experiments/001-rust-foundation/m7-nostd && cargo build` 退出码 0；
