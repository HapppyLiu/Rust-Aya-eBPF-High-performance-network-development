...
完整观察：[`examples/c12_send_sync.rs`](../../experiments/001-rust-foundation/m4-concurrency/examples/c12_send_sync.rs)（20 行）
...
完整观察：[`examples/c13_concurrency.rs`](../../experiments/001-rust-foundation/m4-concurrency/examples/c13_concurrency.rs)（20 行）
...
完整观察：[`examples/c14_atomic.rs`](../../experiments/001-rust-foundation/m4-concurrency/examples/c14_atomic.rs)（22 行）
...
完整推导在 [`acceptance/send-sync-quiz.result.md`](../../acceptance/001-rust-foundation/send-sync-quiz.result.md)。
这里只钉"依据指向哪条编译器判定"。
