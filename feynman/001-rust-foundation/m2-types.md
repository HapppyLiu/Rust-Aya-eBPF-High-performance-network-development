...
完整观察：[`examples/c05_layout.rs`](../../experiments/001-rust-foundation/m2-types/examples/c05_layout.rs)（69 行）
...
完整观察：[`examples/c06_trait.rs`](../../experiments/001-rust-foundation/m2-types/examples/c06_trait.rs)（45 行）
...
完整观察：[`examples/c07_generic.rs`](../../experiments/001-rust-foundation/m2-types/examples/c07_generic.rs)（38 行）
