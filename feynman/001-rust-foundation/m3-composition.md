...
完整观察：[`examples/c08_error.rs`](../../experiments/001-rust-foundation/m3-composition/examples/c08_error.rs)（20 行）
...
完整观察：[`examples/c09_iterator.rs`](../../experiments/001-rust-foundation/m3-composition/examples/c09_iterator.rs)（36 行）
...
完整观察：[`examples/c10_closure.rs`](../../experiments/001-rust-foundation/m3-composition/examples/c10_closure.rs)（29 行）
...
完整观察：[`examples/c11_smart_ptr.rs`](../../experiments/001-rust-foundation/m3-composition/examples/c11_smart_ptr.rs)（29 行）
