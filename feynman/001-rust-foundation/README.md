...
> ⚠️ 本目录属于 **Answer Track**。自测请先用 [`../../learner/001-rust-foundation/mN-*/selfcheck.md`](../../learner/001-rust-foundation/README.md)。

契约：[learning-artifact-contract.md §C](../../contracts/001-rust-foundation/learning-artifact-contract.md)
